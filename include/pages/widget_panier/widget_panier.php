...
.w-panier-produit-img {
    max-width: 128px;
    height: 100px;
    size: auto;
}

.w-panier-produit-content-body {
    min-width: 200px;
}

.w-panier-produit-content-body>div:nth-child(1) {
    text-decoration: underline;
    font-size: large;
    font-weight: 900;
}

.w-panier-produit-content-body .qte {
    font-style: italic;
}

/* .w-panier-produit-content-body>div:nth-child(2){font-style: italic;} */
.w-panier-produit-total {
    text-align: right;
    padding-right: 10px;
}

.w-panier-produit-buttons {
    text-align: center;
}

.w-panier-produit-buttons>button {
    padding: 0 5px;
    height: 20px;
    font-size: 8px;
}
